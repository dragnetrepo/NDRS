    ...
    <div class="pop-overlay">
        <div class="card pop-card border-0 py-4">
            <div class="card-body">
                ...
                <h3 class="pop-text">Great work, your email <span class="text-detail">balamihu@gmail.com</span> has been verified!</h3>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-6 mx-auto">
                    <div class="card border-0 custom-card">
                        <div class="card-body">
                            ...
                            <p class="mt-4 text-center text-muted-3 mb-0">Already have an account? <a href="login.php" class="text-main-primary text-medium text-decoration-none">Log in</a></p>
                        </div>
                    </div>
                </div>
            </div>
