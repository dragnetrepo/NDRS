                                    ...
                                    <div class="d-flex gap-15">
                                        ...
                                        <nav aria-label="breadcrumb">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item"><a href="#" class="text-main-primary text-decoration-none">Academic Staff Union of Universities</a></li>
                                                <li class="breadcrumb-item active" aria-current="page">ASUU Lagos</li>
                                            </ol>
                                        </nav>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center avatar-icon w-100 my-5">
                                        <div class="d-flex avatar-holder">
                                            ...
                                            <div class="ms-2 flex-grow-1">
                                                <h3 class="mb-2 bold-text">ASUU Lagos</h3>
                                                                                ...
                                                                                <div class="ms-2 flex-grow-1">
                                                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                                                        ...
                                                                                        <div class="mb-0 d-flex align-items-center">
                                                                                            <div class="heading-text">Lagos State University (LASU)</div> 
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="d-flex align-items-center avatar-holder">
                                                                                ...
                                                                                <div class="ms-2 flex-grow-1">
                                                                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                                                                        ...
                                                                                        <div class="mb-0 d-flex align-items-center">
                                                                                            <div class="heading-text">University of Lagos (UNILAG)</div> 
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                        ...
                                        <div class="accordion-item mb-3">
                                            ...
                                            <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionUnion">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <a href="#" data-bs-toggle="modal" data-bs-target="#editModal" class="btn btn-size btn-main-primary d-inline-flex">Edit Profile</a>
                                                    </div>
                                                    ...
                                                    <form>
                                                        <div class="row mt-4">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <div class="mb-4">
                                                                    <label class="form-label">Sub Branch Name</label>
                                                                    <input type="text" class="form-control form-control-height" value="University of Lagos (UNILAG)" disabled>
                                                                </div>
                                                                <div class="mb-4">
                                                                    <label class="form-label">Sub Branch Acronym (if applicable)</label>
                                                                    <input type="text" class="form-control form-control-height" value="UNILAG" disabled>
                                                                </div>
                                                                <div class="mb-4">
                                                                    <label class="form-label">Branch Name</label>
                                                                    <input type="text" class="form-control form-control-height" disabled value="ASUU Lagos">
                                                                </div>
                                                                <div class="mb-4">
                                                                    <label class="form-label">Industry</label>
                                                                    <input type="text" class="form-control form-control-height" disabled value="Education">
                                                                </div>
                                                                <div class="mb-4">
                                                                    <label class="form-label">Union Name</label>
                                                                    <input type="text" class="form-control form-control-height" disabled value="Academic Staff Union of Universities (ASUU)">
                                                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0 p-lg-4 p-3">
                <div class="pb-4 border-bottom heading-card bg-white d-flex align-items-center justify-content-between flex-wrap">
                    <h3 class="mb-lg-0 mb-3">Edit Sub Branch</h3>
                    ...
                    <form>
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-9">
                                <div class="mb-4">
                                    <label class="form-label">Sub Branch Name</label>
                                    <input type="text" class="form-control form-control-height" value="University of Lagos (UNILAG)">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Sub Branch Acronym (if applicable)</label>
                                    <input type="text" class="form-control form-control-height" value="UNILAG">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Branch Name</label>
                                    <input type="text" class="form-control form-control-height" value="ASUU Lagos">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Industry</label>
                                    <input type="text" class="form-control form-control-height" value="Education">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Union Name</label>
                                    <input type="text" class="form-control form-control-height" value="Academic Staff Union of Universities (ASUU)">
                                </div>
