    ...
    <div class="auth-container d-flex align-items-center justify-content-center vh-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mx-auto">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-muted-2">Your password has been successfully reset.Click below to enter your account</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 mx-auto">
                    <div class="mt-5">
                        <a href="login.php" class="btn btn-size btn-main-primary w-100">Login to account</a>
                    </div>
                </div>
            </div>
        </div>
