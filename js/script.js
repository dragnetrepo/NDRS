...
if (document.querySelector(".submit-dispute")) {
...
document.querySelector(".avatar-chat").addEventListener('click', function () {
  document.querySelector(".discuss-3").classList.remove("d-none")
})