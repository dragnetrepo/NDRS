...
class sendOutgoingEmailMessages extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:send-outgoing-email-messages';
    ...
    public function handle()
    {
        ...
        $outgoing_messages = OutgoingMessages::where("message_type", "email")->where("status", "pending")->get()->take(10);

        if ($outgoing_messages->isNotEmpty()) {
            foreach ($outgoing_messages as $outgoing_message) {
                try {
