...
const Users = () => {
  ...
  const [isFinishingCustomRoleCreate, setisFinishingCustomRoleCreate] =
    useState(false);
                                          ...
                                          <div className="card-body p-4">
                                            ...
                                            <div className="row mb-4">
                                              <div className="col-lg-5 mb-lg-0 mb-3">
                                                ...
                                                <p className="text-muted-3">
                                                  Fill in the users details into
                                                  the CSV file
                                                </p>
                                              </div>
                                              <div className="col-lg-5 offset-lg-2">
                  ...
                  <div className="d-flex avatar-holder mb-5">
                    <div className="position-relative">
                      <div className="avatar-sm flex-shrink-0">
                        <img
                          src={
                            IndividualUser.user_photo || "images/download.png"
                          }
                          className="img-fluid object-position-center object-fit-cover w-100 h-100"
                          alt="Avatar"
                        />
                                  ...
                                  <div className="d-flex align-items-center avatar-holder">
                                    <div className="position-relative">
                                      <div className="avatar-sm flex-shrink-0">
                                        <img
                                          src={
                                            dispute.involved_parties.accused
                                              .logo
                                          }
                                          className="img-fluid object-position-center object-fit-cover w-100 h-100"
                                          alt="Avatar"
        ...
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content p-lg-4 border-0">
            <div className="modal-header justify-content-between">
              <h1 className="modal-title fs-5">Create Profile</h1>
                          ...
                          {getSettlementBodyMembers.map((member_profile) => (
                            <tr>
                              ...
                              <td>
                                ...
                                {member_profile.status !== "pending" && (
                                  <span>{member_profile.date_joined}</span>
                                )}
                              </td>
                              <td>
                                <a
            ...
            <div className="modal-header justify-content-between">
              ...
              <div className="gap-10 d-flex align-items-center">
                ...
                <button
                  ...
                  disabled={isFinishingCustomRoleCreate}
                >
                              ...
                              <div className="col-lg-5">
                                <div className="d-flex flex-column gap-10">
                                  {permissions[permission].map((item) => (
                                    <div
                                      className="form-check d-flex align-items-center form-switch"
                                      key={`custom-permission-${item._id}`}
                                    >
                                      <input
                                        className="form-check-input"
                                        type="checkbox"
                                        role="switch"
                                        id={`custom-permission-${item._id}`}
                                        value={item._id}
                                        checked={isPermChecked[item._id] === 1}
                                        onChange={(e) =>
                                          handlePermissionStateChange(e)
                                        }
                                      />
                                      <label
                                        className="form-check-label ms-4"
                                        htmlFor={`custom-permission-${item._id}`}
                                      >
                                        {item.name}
                                      </label>
                                    </div>
