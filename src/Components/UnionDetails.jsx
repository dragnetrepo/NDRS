...
const UnionDetails = () => {
  ...
  const handleDelete = async (e, id, unionAdmin, setUnionAdmin) => {
    e.preventDefault();
    ...
    try {
      ...
      const response = await fetch(baseUrl + `/api/union/remove-admin/${id}`, {
        ...
        body: JSON.stringify(unionAdmin),
      });
          ...
          <div className="modal-content border-0 p-lg-4 p-3">
            ...
            <div className="modal-body">
              ...
              <button
                ...
                onClick={(e) =>
                  handleDelete(e, selectedAdminId, unionAdmin, setUnionAdmin)
                }
              >
                Yes, Remove Admin
              </button>
