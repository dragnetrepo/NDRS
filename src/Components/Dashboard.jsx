                              ...
                              >
                                <div className="card dash-card bg-custom-color-2 h-100 border-0">
                                  <div className="card-body">
                                    ...
                                    <p className="mb-2">
                                      Create Branches and invite their
                                      respective admins
                                    </p>

                                    <p className="action mb-0">
                                      Create Branches
                                    </p>
                                  </div>
                                </div>
                              ...
                              >
                                <div className="card dash-card bg-custom-color-2 h-100 border-0">
                                  <div className="card-body">
                                    ...
                                    <p className="mb-2">
                                      Create Organizations and invite their
                                      respective admins
                                    </p>
                                ...
                                >
                                  <div className="card dash-card bg-custom-color-2 h-100 border-0">
                                    <div className="card-body">
                                      ...
                                      <p className="mb-2">
                                        Invite users individually or in bulk to
                                        NDRS
                                      </p>
                                    ...
                                    {periodMessage.period_text &&
                                      periodMessage.report_text && (
                                        <h3 className="chart-text">
                                          ...
                                          in total time of Dispute Resolutions
                                          over the past{" "}
                                          <span className="text-main-primary">
                                            {periodMessage.period_text}
                                          </span>
                          ...
                          user.permissions.includes(
                            ...
                            <div className="mb-4">
                              ...
                              <div className="card dash-card">
                                <div className="card-body">
                                  {dashboard?.recent_messages?.data?.length >
                                  0 ? (
                        ...
                        {user.permissions &&
                          (user.permissions.includes("create dispute") ||
                            ...
                            <div className="mb-4">
                              ...
                              <div className="card dash-card">
                                <div className="card-body">
                                  {dashboard?.recent_documents?.data?.length >
                                  0 ? (
