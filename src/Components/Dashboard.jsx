										...
										<div className="row">
											<div className="col-lg-8">
												<div className="row mb-5">
													{(user.permissions.includes("approve dispute") || user.permissions.includes("change dispute case status")) && (
														<div className="col-lg-4 mb-lg-0 mb-3">
															<Link to="/disputes" className="text-main-primary text-decoration-none text-medium">
																	...
																	<div className="card-body">
																		<div className="d-flex avatar-holder align-items-center mb-3">
																			<div className="position-relative flex-shrink-0">
																				<img src="/images/dispute-icon.svg" className="img-fluid" alt=""/>
																			</div>
													...
													<div className="col-lg-4 mb-lg-0 mb-3">
														{user.permissions && (user.permissions.includes("create unions")) ? (
															<Link to="/unions" className="text-decoration-none">
																<div className="card dash-card bg-custom-color-2 h-100 border-0">
																	<div className="card-body">
																		<div className="d-flex avatar-holder align-items-center mb-3">
																			<div className="position-relative flex-shrink-0">
																				<img src="/images/union-icon.svg" className="img-fluid" alt="" />
																			</div>
																			<div className="ms-2 flex-grow-1">
																...
																<div className="card dash-card bg-custom-color-2 h-100 border-0">
																	<div className="card-body">
																		<div className="d-flex avatar-holder align-items-center mb-3">
																			...
																			<div className="ms-2 flex-grow-1">
																				<h5 className="mb-0">Create Branches</h5>
																			</div>
																		</div>
																		<p className="mb-2">
																			Create Branches and invite their respective
																			admins
																		</p>

																		<p className="action mb-0">Create Branches</p>
																	</div>
																</div>
															</Link>
														) : (user.permissions.includes("create sub branches")) ? (
															<Link to="/subBranch" className="text-decoration-none">
																<div className="card dash-card bg-custom-color-2 h-100 border-0">
																	<div className="card-body">
																		<div className="d-flex avatar-holder align-items-center mb-3">
																			<div className="position-relative flex-shrink-0">
																			...
																			<div className="ms-2 flex-grow-1">
																				<h5 className="mb-0">Create Organizations</h5>
																			</div>
																		</div>
																		<p className="mb-2">
																			Create Organizations and invite their respective
																			admins
																		</p>

																		<p className="action mb-0">Create Organizations</p>
																	</div>
																</div>
															</Link>
														): null}
															...
															<Link to="/users" className="text-decoration-none">
																<div className="card dash-card bg-custom-color-2 h-100 border-0">
																	<div className="card-body">
																		<div className="d-flex avatar-holder align-items-center mb-3">
																			<div className="position-relative flex-shrink-0">
																				<img src="/images/userz-icon.svg" className="img-fluid" alt="" />
																			</div>
																			<div className="ms-2 flex-grow-1">
												...
												{user.permissions && (user.permissions.includes("view reports") || user.permissions.includes("download reports")) && (
													<div className="d-flex justify-content-between align-items-center mb-2">
														...
														<Link to="/reports" className="text-main-primary text-decoration-none text-medium">
															Show all
														</Link>
													</div>
												)}
												...
												{user.permissions && (user.permissions.includes("participate in resolution")) && (
													<div className="mb-4">
														<div className="d-flex justify-content-between align-items-center mb-2">
															...
															<Link to="/discussions" className="text-main-primary text-decoration-none text-medium">
																Show all
															</Link>
														</div>
