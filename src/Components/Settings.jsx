  ...
  const twoFactorAuthentification = async (event) => {
    ...
    try {
      ...
      const res = await fetch(baseUrl + "/api/notifications/update-setting", {
        ...
        body: JSON.stringify({
          setting: isChecked ? "1" : "0",
          option: isChecked ? "" : "email",
        }),
      });
                                        ...
                                        <div className="col-lg-9">
                                          ...
                                          <div className="row">
                                            <div className="col-lg-4 offset-lg-8">
                                              <button className="btn btn-size w-100 btn-main-outline-primary">
                                                <img
                                    ...
                                    <div className="card-body p-4">
                                      <div className="d-flex justify-content-between align-items-center flex-lg-nowrap flex-wrap">
                                        <div className="text-start mb-lg-0 mb-3">
                                          <h4>Mentions</h4>
                                          <p className="mb-0 text-muted-3">
                                            Notifications about any mentions in
                                            any discussions on the platform
                                          </p>
                                        </div>
                                    ...
                                    <div className="card-body p-4">
                                      <div className="d-flex justify-content-between align-items-center flex-lg-nowrap flex-wrap">
                                        <div className="text-start mb-lg-0 mb-3">
                                          <h4>Requests</h4>
                                          <p className="mb-0 text-muted-3">
                                            Specific notifications about case
                                            verdicts requiring your review,
                                            polls etc
                                          </p>
                                        </div>
                                    ...
                                    <div className="card-body p-4">
                                      <div className="d-flex justify-content-between align-items-center flex-lg-nowrap flex-wrap">
                                        <div className="text-start mb-lg-0 mb-3">
                                          <h4>Case Updates</h4>
                                          <p className="mb-0 text-muted-3">
                                            General updates about a case, like
                                            document updates and discussions
                                          </p>
                                        </div>
                                    ...
                                    <div className="card-body p-4">
                                      <div className="d-flex justify-content-between align-items-center flex-lg-nowrap flex-wrap">
                                        <div className="text-start mb-lg-0 mb-3">
                                          <h4>Invites</h4>
                                          <p className="mb-0 text-muted-3">
                                            Notifications when you get invited
                                            to a new dispute case or branch
                                          </p>
                                        </div>
