...
const Settings = () => {
  ...
  const submiteNewOrganzationRequest = async (e) => {
    ...
    try {
      const res = await fetch(
        baseUrl + "/api/users/requests/new-organization",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const submitDeleteOrganzationRequest = async (e) => {
    ...
    try {
      const res = await fetch(
        baseUrl + "/api/users/requests/delete-organization",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
                                      ...
                                      <form>
                                        <div className="row mt-4">
                                          ...
                                          <div className="col-lg-9">
                                            ...
                                            {!allowedRoleChangeUsers.includes(
                                              user.user_role?.role_name
                                            ) && (
                                              <div className="mb-4">
                                                <a
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content border-0 p-lg-4 p-3">
            <div className="text-end">
              <button
                type="button"
                id="request-new-role-close-modal"
                className="btn-close"
            ...
            <div className="modal-body">
              ...
              <form>
                ...
                <ul className="list-group new-role">
                  {getAdminRoles.length &&
                    getAdminRoles.map((item) => (
                      <li
                        className={`list-group-item d-flex justify-content-between cursor-pointer ${
                          newRole.role_id === item._id ? `active` : ``
                        } p-3`}
                        onClick={(e) => handleSetNewRoleSelected(item._id)}
                      >
                        {item.name}
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content border-0 p-lg-4 p-3">
            ...
            <div className="modal-body">
              ...
              <form
                onSubmit={(e) => {
                  submiteNewOrganzationRequest(e);
                }}
              >
                <div className="mb-4">
                  ...
                  >
                    ...
                    {getOrgnizations.length &&
                      getOrgnizations.map((item) => (
                        <option
                          selected={item._id === newOrg.org_id}
                          value={item._id}
                        >
                          {item.name}
                        </option>
        ...
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content border-0 p-lg-4 p-3">
            <div className="text-end">
              <button
                type="button"
                id="delete-organization-modal-close"
                className="btn-close"
                data-bs-dismiss="modal"
                aria-label="Close"
              ></button>
            ...
            <div className="modal-body">
              ...
              <form
                onSubmit={(e) => {
                  submitDeleteOrganzationRequest(e);
                }}
              >
                <div className="mb-4">
