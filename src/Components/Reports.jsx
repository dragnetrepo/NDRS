...
const Reports = () => {
	...
	const reportButtonClicked = async (identifier) => {
		console.log("clicked");
		document.querySelectorAll('.report-btn').forEach(button => button.classList.remove("active-date"));

		document.getElementById(identifier).classList.add("active-date");
		var filter_by = document.getElementById(identifier).getAttribute("filter-by");
												...
												<div className="card p-lg-4 mb-5">
													<div className="card-body">
														<div className="row align-items-center">
															<div className={periodMessage.period_text && periodMessage.report_text ? `col-lg-3` : ``}>
															...
															<div className={`${periodMessage.period_text && periodMessage.report_text ? `col-lg-8 offset-lg-1` : `col-lg-12`}`}>
																<div className="chart-tab d-flex align-items-center gap-10 justify-content-end mb-3">
																	<button className="btn btn-link ft-sm text-decoration-none text-muted-3 report-btn" filter-by={`1 week`} id="1-week" onClick={(e) => { reportButtonClicked("1-week") }}>
																		1 week
																	</button>
																	<button className="btn btn-link ft-sm text-decoration-none text-muted-3 report-btn" filter-by={`1 month`} id="1-month" onClick={(e) => { reportButtonClicked("1-month") }}>
																		1 month
																	</button>
																	<button className="btn btn-link ft-sm text-decoration-none text-muted-3 report-btn" filter-by={`4 months`} id="4-months" onClick={(e) => { reportButtonClicked("4-months") }}>
																		4 months
																	</button>
																	<button className="btn btn-link ft-sm text-decoration-none text-muted-3 active-date report-btn" filter-by={`8 months`} id="8-months" onClick={(e) => { reportButtonClicked("8-months") }}>
																		8 months
																	</button>
																	<button className="btn btn-link ft-sm text-decoration-none text-muted-3 report-btn" filter-by={`1 year`} id="1-year" onClick={(e) => { reportButtonClicked("1-year") }}>
																		1 year
																	</button>
																	<button className="btn btn-link ft-sm text-decoration-none text-muted-3 report-btn" filter-by={`all time`} id="all-time" onClick={(e) => { reportButtonClicked("all-time") }}>
																		Max
																	</button>
																</div>
																{isComponentLoading ? (
