											...
											<div className="col-lg-12">
												<div className="margin-top-negative">
													...
													>
														...
														{user.permissions && (user.permissions.includes("view dispute notifications")) && (
															<li className="nav-item" role="presentation">
																<button
																className="nav-link"
														...
														>
															<div className="row mt-5">
																<div className="col-lg-2">
																	...
																	{user.permissions && (user.permissions.includes("invite dispute participants")) && (
																		<button
																				...
																				<div className="card-body p-4">
																					...
																					<div className="card no-admin-card rounded-0">
																						...
																						<div className="text-center">
																							...
																							Enter an admins email and role
																							to send invite
																							</p>
																							<div className="text-center">
																							<img
