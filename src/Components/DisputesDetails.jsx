...
const DisputesDetails = () => {
  ...
  // const EditDisputes = async (id, getDisputes) => {
  //   try {
  //     const baseUrl = "https://phpstack-1245936-4460801.cloudwaysapps.com/dev";
  //     const token = localStorage.getItem("token");
  ...
  //     const res = await fetch(baseUrl + `/api/case/edit/${id}`, {
  //       headers: {
  //         "content-Type": "application-json",
  //         Authorization: `Bearer ${token}`,
  //       },
  //       body: JSON.stringify(getDisputes),
  //     });
                            ...
                            <div class="row mt-5">
                              <div class="col-lg-2">
                                ...
                                >
                                  ...
                                  <button
                                    class="nav-link tab-v text-start"
                                    id="v-pills-folder-tab"
                                    data-bs-toggle="pill"
                                    data-bs-target="#v-pills-folder"
                                    type="button"
                                    role="tab"
                                    aria-controls="v-pills-folder"
                                    aria-selected="false"
                                  >
                                    All Folders
                                  </button>
                                            ...
                                            <table class="table table-list">
                                              ...
                                              <tbody>
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                    <div
                                                      title="Matthews Jack - Solar Utility Approval - Dawn Solar Lv1"
                                                      class="text-truncate max-200"
                                                    >
                                                      Matthews Jack - Solar
                                                      Utility Approval - Dawn
                                                      Solar Lv1
                                                    </div>
                                                  </td>
                                                  <td>1.2 MB</td>
                                                ...
                                                <tr>
                                                  ...
                                                  <td>
                                                    <div
                                                      title="Hillary Wilton - Solar Sales Receipt Installation"
                                                      class="text-truncate max-200"
                                                    >
                                                      Hillary Wilton - Solar
                                                      Sales Receipt Installation
                                                    </div>
                                                  </td>
                                                  <td>1.2 MB</td>
            ...
            <div class="modal-body">
              ...
              <form>
                ...
                <ul class="list-group new-role">
                  <li class="list-group-item d-flex justify-content-between active p-3">
                    National Union Admin{" "}
                    <i class="bi bi-check-circle-fill text-main-primary"></i>
                  </li>
                ...
                <div class="mt-4">
                  <button class="btn btn-size btn-main-primary w-100">
                    Send Request
                  </button>
                </div>
              </form>
            ...
            <div class="modal-body">
              <div class="row my-4">
                ...
                <div class="col-lg-5">
                  <div class="d-flex align-items-center justify-content-between gap-15">
                    <select
                      class="form-control form-control-height w-50"
                      name="role"
                      onChange={onHandleChangeUser}
                    >
