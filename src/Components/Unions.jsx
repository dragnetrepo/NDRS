                ...
                <div className="col-lg-5">
                  <div className="d-flex align-items-center justify-content-between gap-15">
                    <select
                      ...
                      name="role"
                      onChange={onHandleChangeUnion}
                      defaultValue="" // Setting an empty default value to indicate no selection
                    >
                      <option value="" hidden>
                        Select role
                      </option>
                      ...
                      <option value="Employers (Companies & Organizations)">
                        Employers (Companies & Organizations)
                      </option>
                      <option value="Staff (Union Members)">
                        Staff (Union Members)
                      </option>
                      ...
                      <option value="Industrial Arbitration Panel (Tribunal)">
