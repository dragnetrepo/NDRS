...
const DiscussionIinc = () => {
	...
	const fetchCaseStatus = async () => {
		...
		const res = await fetch(baseUrl + "/api/case/get-statuses", {
			headers: {
	...
	const handleStatus = async (e) => {
		...
		formData.append("resolution_reached", resolution);
		...
		const res = await fetch(baseUrl + `/api/case/change-status/${caseId}`, {
			method: "POST",
			headers: {
	...
	const handlePollResults = async (message_id) => {
		...
		try {
		const res = await fetch(
			`${baseUrl}/api/case/discussions/${id}/get-poll-result?message_id=${message_id}`,
			{
			headers: {
				"Content-Type": "application/json",
				Authorization: `Bearer ${token}`,
				...
				<div className="flex-lg-fill bg-white overflow-auto vstack vh-lg-100 position-relative">
					...
					>
						...
						<div className="discussion-section d-flex">
								...
								<div className="chat-height">
									...
									>
										...
										<div className="position-relative">
											...
											<img
												src={
												item.sender.photo || "/images/download.png"
												}
								...
								<div className="chat-box d-flex flex-column h-100">
									...
									<div className="d-flex align-items-center avatar-holder avatar-chat cursor-pointer">
										...
										<div className="avatar-sm flex-shrink-0">
											<img
											src={
												discussionMessagesInfo.group_photo ||
												"/images/download.png"
											}
											className="img-fluid object-position-center object-fit-cover w-100 h-100"
											alt="Avatar"
										...
										<div className="ms-2 flex-grow-1">
										<h5 className="mb-0">
											{discussionMessagesInfo.group_name}
										</h5>
										</div>
									</div>
									</div>
										...
										<div className="container-fluid">
											<div className="messages-container py-5">
												{discussionMessages.map((item) => (
													<div
													key={item._id}
													className={item.sender.sender === "You" ? "d-flex flex-column align-items-end" : "d-flex flex-column align-items-start"}
													>
													{item.type === "text" ? (
														<>
														...
														<div className={item.sender.sender === "You" ? "d-flex flex-column align-items-end" : "d-flex flex-column align-items-start"}>
																	...
																	<div className="card-body">
																		...
																		<div className="d-flex align-items-center gap-10 justify-content-center mt-3">
																			<div className="avatars margin-unset">
																				...
																				{item.message.vote_results.length > 5 ? (
																			...
																			<p className="mb-0">
																				<a href="javascript:void(0)" className="text-medium text-main-primary text-decoration-none"
																					data-bs-toggle="modal"
																					data-bs-target="#resultsModal"
																					onClick={() => handlePollResults(item._id) }>
																				View results
																				</a>
																			</p>
																		</div>
														...
														<div className={item.sender.sender === "You" ? "d-flex flex-column align-items-end" : "d-flex flex-column align-items-start"}>
															<a
																href={item.message.path}
																target="_blank"
																rel="noopener noreferrer"
																download={item.message.name}
																className={`text-decoration-none d-flex ${item.sender.sender === "You" ? `justify-content-end` : `justify-content-start`}`}
															>
														...
														{item.message.resolution_reached === "yes" ? (
															<div className={item.sender.sender === "You" ? "d-flex flex-column align-items-end mb-3" : "d-flex flex-column align-items-start mb-3"}>
															...
															<div className={`receiver d-flex flex-column ${item.sender.sender === "You" ? `align-items-end` : `align-items-start`} mb-3`}>
									...
									<div className="chat-footer d-flex align-items-center justify-content-between bg-custom-color-2 px-3 gap-15 py-2">
										<div className="dropdown">
											...
											{user.permissions && (user.permissions.includes("change dispute case status")) && (
												<li>
													<a
							...
							<div className="discuss-3 flex-shrink-0 p-3" style={{ display: removeDetails ? "none" : "block" }} >
					...
					<div className="modal-content p-lg-4 border-0">
						...
						<form onSubmit={handleStatus}>
							...
							<div className="d-flex align-items-center justify-content-between mb-4">
								...
								<div className="d-flex  align-items-center ">
								<button
									className="btn btn-main-primary btn-size me-3"
